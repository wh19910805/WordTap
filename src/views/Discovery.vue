<template>
  <div class="min-h-screen bg-[var(--background-color)] pb-20">
    <!-- 顶部 Tab 切换 -->
    <div class="sticky top-0 z-10 bg-white/70 backdrop-blur-md border-b border-white/30">
      <div class="flex">
        <button
          v-for="tab in tabs"
          :key="tab.key"
...
function getCourseCover(courseId, courseName) {
  ...
  const iconPaths = {
    ...
    Map:
      "M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 7m0 13V7m0 0L9 7",
    Home:
    ...
    <svg width="400" height="300" viewBox="0 0 400 300" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <filter id="shadow" x="-50%" y="-50%" width="200%" height="200%">
          <feDropShadow dx="0" dy="4" stdDeviation="8" flood-color="${
            gradient.from
          }" flood-opacity="0.3"/>
        </filter>
      </defs>
      ...
      <g transform="translate(200, 110)" filter="url(#shadow)">
        ...
        <svg x="-25" y="-25" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="${
          gradient.from
      ...
      <text x="200" y="200" font-family="system-ui, -apple-system, sans-serif" font-size="24" font-weight="600" fill="white" text-anchor="middle" letter-spacing="0.5">
        ${
          courseName && courseName.length > 12
