          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            >
              ...
              >
                ...
                <!-- 课程信息 -->
                <div class="p-3">
                  <h3 class="font-semibold text-base mb-1 line-clamp-2 text-gray-900 group-hover:text-indigo-600 transition-colors duration-300">
                    {{ course.name }}
                  </h3>
                  <div class="flex items-center justify-between text-xs text-gray-500 mt-2">
                    <span class="bg-indigo-100 text-indigo-600 px-2 py-0.5 rounded-full">{{ course.category || '官方' }}</span>
          ...
          >
            ...
            <div class="relative w-full aspect-[4/3] overflow-hidden rounded-t-3xl">
              ...
              <div class="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                <div class="w-12 h-12 bg-white rounded-full flex items-center justify-center transform scale-90 group-hover:scale-100 transition-transform duration-300">
